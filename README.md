...
* Compile command for Linux (tested on Elementary OS 7.1): `g++ main.cpp -std=c++17 -Wl,--start-group framework2/libredgpu_f2.so framework2/libs_linux/libopenFrameworks.a -lm -lGL -lX11 -lglfw framework2/libs_linux/libfbxsdk.a -lxml2 -licuuc -lz framework2/libs_linux/libtess2.a -lGLEW -lpugixml -lcurl framework2/libs_linux/libassimp.so -lgstreamer-1.0 -lgobject-2.0 -lglib-2.0 -lgstapp-1.0 -lgstbase-1.0 -lgstvideo-1.0 -luriparser -lgtk-3 -lfontconfig -lfreetype -lopenal -lsndfile framework2/libs_linux/libkiss.a -lfreeimage -Wl,--end-group`
